...
import com.ways.composenews.presentation.common.NewsButton
import com.ways.composenews.presentation.common.NewsTextButton
...
import com.ways.composenews.ui.theme.IndicatorWidth
...
fun OnBoardingScreen(
    ...
    Column(
        ...
        HorizontalPager(state = pagerState) { position ->
            OnBoardingPage(page = onBoardingPages[position])
        }
        ...
        Row(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                if (buttonState.value.first().isNotEmpty()) {
                    NewsTextButton(text = buttonState.value.first(), onClick = {
                        scope.launch {
